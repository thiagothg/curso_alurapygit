...
class Leilao:
    ...
    def propoe(self, lance: Lance):
        if self._lance_valido(lance):
            ...
            raise LanceInvalido('O mesmo usuario nao pode propor dois lances seguindos! ')
    ...
    def _usurios_diferentes(self, lance):
    ...
    def _lance_valido(self, lance):
        return not self._tem_lances() or (self._usurios_diferentes(lance)
